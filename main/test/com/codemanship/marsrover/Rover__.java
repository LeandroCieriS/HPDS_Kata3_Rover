...
public class Rover__ {
    ...
    @Test
    public void could_detect_obstacle_in_Front(){
        Rover rover = new Rover(West, new Position(0, 0));
        rover.setObstaclesMap(new Position(0,2), new Position(0,1));
        rover.go(Forward, Right, Forward, Forward, Right, Forward, Right, Forward, Left, Forward);
